...
export default function FacebookPostsScreen() {
  ...
  const displayPicture = accountAnalytics?.profilePicture || profilePicture;
  const displayName = accountAnalytics?.name || accountName;
  const displayHandle = accountAnalytics?.username ? `@${accountAnalytics.username}` : `@${accountName || 'facebook'}`;
  const displayBio = accountAnalytics?.about || null;

  // We no longer rely on dynamic renderAnalytics mapping. Let's keep it empty or remove it.
  // const FILTERED_ANALYTICS_KEYS = ['name', 'username', 'about', 'category', 'website', 'profilePicture', 'id', 'followers', 'page_views_total', 'page_post_engagements', 'page_impressions', 'page_video_views'];
    ...
    <View>
      ...
      <View style={styles.profileInfoSection}>
        ...
        {accountAnalyticsLoading ? (
          <ActivityIndicator size="small" color={APP_COLORS.primary} style={{ marginVertical: 32 }} />
        ) : (
          <View style={styles.analyticsSection}>
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16, paddingHorizontal: 4 }}>
              <Text style={styles.analyticsSectionTitle}>PAGE INSIGHTS 📊</Text>
              {accountAnalytics?.category && (
                <View style={{ backgroundColor: APP_COLORS.primaryContainer, paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6 }}>
                  <Text style={{ fontSize: 11, color: APP_COLORS.primary, fontWeight: '700', textTransform: 'uppercase' }}>{accountAnalytics.category}</Text>
                </View>
              )}
            </View>
            ...
            <View style={styles.analyticsStatsGrid}>
              ...
              <View style={styles.analyticsStatCard}>
                <View style={styles.analyticsStatHeaderRow}>
                  ...
                  <Text style={styles.analyticsStatLabel}>Page Fans</Text>
                </View>
                <Text style={styles.analyticsStatValue}>{(accountAnalytics?.page_fans || 0).toLocaleString()}</Text>
              </View>
              <View style={styles.analyticsStatCard}>
                <View style={styles.analyticsStatHeaderRow}>
                ...
                <Text style={styles.analyticsStatValue}>{(accountAnalytics?.page_follows || accountAnalytics?.followers || 0).toLocaleString()}</Text>
              </View>
              ...
              <View style={styles.analyticsStatCard}>
                <View style={styles.analyticsStatHeaderRow}>
                  ...
                  <Text style={styles.analyticsStatLabel}>Engagements</Text>
                </View>
                <Text style={styles.analyticsStatValue}>{(accountAnalytics?.page_post_engagements || 0).toLocaleString()}</Text>
              </View>
              <View style={styles.analyticsStatCard}>
                <View style={styles.analyticsStatHeaderRow}>
                  <BarChart2 size={16} color="#8e44ad" />
                  <Text style={styles.analyticsStatLabel}>CTA Clicks</Text>
                </View>
                <Text style={styles.analyticsStatValue}>{(accountAnalytics?.page_total_actions || 0).toLocaleString()}</Text>
              </View>

              {/* Views */}
              <View style={styles.analyticsStatCard}>
                <View style={styles.analyticsStatHeaderRow}>
                  <Eye size={16} color="#f39c12" />
                  <Text style={styles.analyticsStatLabel}>Page Views</Text>
                </View>
                <Text style={styles.analyticsStatValue}>{(accountAnalytics?.page_views_total || 0).toLocaleString()}</Text>
              </View>
              <View style={styles.analyticsStatCard}>
                <View style={styles.analyticsStatHeaderRow}>
                  <Eye size={16} color="#3498db" />
                  <Text style={styles.analyticsStatLabel}>Media Views</Text>
                </View>
                <Text style={styles.analyticsStatValue}>{(accountAnalytics?.page_media_view || 0).toLocaleString()}</Text>
              </View>

              {/* Video */}
              <View style={styles.analyticsStatCard}>
                <View style={styles.analyticsStatHeaderRow}>
                  <Video size={16} color="#1abc9c" />
                  <Text style={styles.analyticsStatLabel}>Video Views</Text>
                </View>
                <Text style={styles.analyticsStatValue}>{(accountAnalytics?.page_video_views || 0).toLocaleString()}</Text>
              </View>
              <View style={styles.analyticsStatCard}>
                <View style={styles.analyticsStatHeaderRow}>
                  <Video size={16} color="#2980b9" />
                  <Text style={styles.analyticsStatLabel}>30s Video Views</Text>
                </View>
                <Text style={styles.analyticsStatValue}>{(accountAnalytics?.page_video_complete_views_30s || 0).toLocaleString()}</Text>
              </View>

              {/* Post Impressions */}
              <View style={styles.analyticsStatCard}>
                <View style={styles.analyticsStatHeaderRow}>
                  <ImageIcon size={16} color="#e67e22" />
                  <Text style={styles.analyticsStatLabel}>Post Impressions</Text>
                </View>
                <Text style={styles.analyticsStatValue}>{(accountAnalytics?.page_posts_impressions || 0).toLocaleString()}</Text>
              </View>
              <View style={styles.analyticsStatCard}>
                <View style={styles.analyticsStatHeaderRow}>
                  <Users size={16} color="#16a085" />
              ...
              <View style={styles.analyticsStatCard}>
                <View style={styles.analyticsStatHeaderRow}>
                  <Users size={16} color="#27ae60" />
                  <Text style={styles.analyticsStatLabel}>New Follows</Text>
                </View>
                <Text style={styles.analyticsStatValue}>{(accountAnalytics?.page_daily_follows || 0).toLocaleString()}</Text>
              </View>
              <View style={styles.analyticsStatCard}>
                <View style={styles.analyticsStatHeaderRow}>
                  <Users size={16} color="#c0392b" />
                  <Text style={styles.analyticsStatLabel}>Unfollows</Text>
                </View>
                <Text style={styles.analyticsStatValue}>{(accountAnalytics?.page_daily_unfollows_unique || 0).toLocaleString()}</Text>
              </View>

              {/* Profile Extra */}
              <View style={styles.analyticsStatCard}>
                <View style={styles.analyticsStatHeaderRow}>
                  <MessageCircle size={16} color="#2c3e50" />
                  <Text style={styles.analyticsStatLabel}>Talking About</Text>
                </View>
                <Text style={styles.analyticsStatValue}>{(accountAnalytics?.talking_about_count || 0).toLocaleString()}</Text>
              </View>
              <View style={styles.analyticsStatCard}>
                <View style={styles.analyticsStatHeaderRow}>
                  <ExternalLink size={16} color="#7f8c8d" />
                  <Text style={styles.analyticsStatLabel}>Were Here</Text>
                </View>
                <Text style={styles.analyticsStatValue}>{(accountAnalytics?.were_here_count || 0).toLocaleString()}</Text>
              </View>
